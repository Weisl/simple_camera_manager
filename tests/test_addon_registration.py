...
_REPRESENTATIVE_CLASSES = (
    ...
    _addon.camera_presets.CAM_MANAGER_OT_camera_preset_add,
    _addon.camera_presets.CAM_MANAGER_MT_camera_presets,
    _addon.pie_menu.CAM_MANAGER_OT_apply_builtin_camera_preset,
